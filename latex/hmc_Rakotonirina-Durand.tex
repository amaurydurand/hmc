...
\begin{Rque}
	...
	$k = 1$ suffit pour tous les résultats énoncés sauf pour la proposition \ref{prop:rever_dicret} où on aura besoin de $k = 2$.
\end{Rque}
...
\begin{Prop}[réversibilité]\label{prop:rever_dicret}
